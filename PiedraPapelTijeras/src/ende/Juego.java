...
public class Juego {
    public static void main(String[] args) {
        ...
        do
        {
            ...
            System.out.println("ende.Jugador 1: " + opcion_JUGADOR1+"\t ende.Jugador 1 - Partidas ganadas: " + EXITOS_jugador1);
            opcion_JUGADOR2 = p2.opcion_al_azar();
            System.out.println("ende.Jugador 2: " + opcion_JUGADOR2+"\t ende.Jugador 2 - Partidas ganadas: " + EXITOS_jugador2);
            
            if((opcion_JUGADOR1.equals("piedra"))&&(opcion_JUGADOR2.equals("papel")))
            {
                System.out.println("ende.Jugador 2 GANA");
            ...
            else if((opcion_JUGADOR1.equals("papel"))&&(opcion_JUGADOR2.equals("piedra")))
            {
                ...
                System.out.println("ende.Jugador 1 GANA");
            }
